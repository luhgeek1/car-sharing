...
export default function EditCarPage({
  ...
  if (carQuery.isLoading) {
    return (
      <div className="rounded-xl border border-white/10 bg-white/[0.02] p-8 text-sm text-white/55">
        Loading…
      </div>
    );
  }
  ...
  if (carQuery.isError || !carQuery.data) {
    return (
      <div className="rounded-xl border border-white/10 bg-white/[0.02] p-8 text-sm text-red-300">
